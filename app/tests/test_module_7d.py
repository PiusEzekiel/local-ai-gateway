...
def test_settings_assets_are_versioned_and_ui_is_modular():
    ...
    assert "/dashboard/assets/settings.css?v=8c-20260920" in html
    assert 'from "./settings.js?v=8c-20260920"' in dashboard
    assert 'initializeSettings();' in dashboard
    assert 'if (page === "settings") loadSettings();' in dashboard
    assert 'from "./api.js?v=8c-20260920"' in settings
