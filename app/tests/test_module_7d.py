...
def test_settings_assets_are_versioned_and_ui_is_modular():
    ...
    assert "/dashboard/assets/settings.css?v=9c1-20260920" in html
    assert 'from "./settings.js?v=9c1-20260920"' in dashboard
    assert 'initializeSettings();' in dashboard
    assert 'if (page === "settings") loadSettings();' in dashboard
    assert 'from "./api.js?v=9c1-20260920"' in settings
